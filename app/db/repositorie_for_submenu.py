...
class RepositoriesSubMenus:
    ...
    async def create(self, data: CreateSubMenuRequest, id_menu: int):
        query = (
            insert(SubMenu)
    ...
    async def get(self, id_menu: int, id_submenu: int):
    ...
    async def update(self, id_menu: int, id_submenu: int, data: CreateSubMenuRequest):
        query = (
            update(SubMenu)
